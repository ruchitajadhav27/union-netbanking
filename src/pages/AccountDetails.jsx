    ...
    <DashboardLayout>
      ...
      <div style={{
        ...
        <div style={{ fontSize: "13px" }}>
          ...
          <span style={{ color: "#0645ad", cursor: "pointer" }} onClick={() => navigate("/account-summary")}>
            Accounts Summary
          </span>
          <span style={{ color: "#555", margin: "0 3px" }}>&gt;</span>
          <strong style={{ color: "#1a237e", fontWeight: "700" }}>Account Details</strong>
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ border: "1px solid #ccc", background: "#fff" }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", padding: "8px 10px", borderBottom: "1px solid #ddd" }}>
              <button onClick={() => navigate("/account-summary")}
                style={{ border: "1px solid #bbb", background: "#f5f5f5", padding: "4px 18px", fontSize: "13px", cursor: "pointer", color: "#333" }}>
                Back
              </button>
            </div>

            {/* ── General Details ── */}
            <div style={{ padding: "5px 10px", fontSize: "13px", color: "#0645ad", borderBottom: "1px solid #ddd", background: "#fff" }}>
              General Details
            </div>
            ...
            {/* More Details */}
            <div style={{ display: "flex", justifyContent: "flex-end", padding: "8px 10px", borderBottom: "1px solid #ddd" }}>
              <button style={{ border: "1px solid #bbb", background: "#f5f5f5", padding: "4px 12px", fontSize: "13px", cursor: "pointer", color: "#333" }}>
                + More Details
              </button>
            </div>
            ...
            <div style={{ padding: "8px 10px", borderBottom: "1px solid #ddd" }}>
              <button style={{
                ...
                padding: "4px 10px", border: "1px solid #0645ad",
                background: "#fff", color: "#0645ad", fontSize: "13px", cursor: "pointer"
              }}>
                View Statement
              ...
              <tbody>
                {transactions.map((t) => (
                  <tr key={t.id} style={{ borderBottom: "1px solid #eee" }}>
                    <td style={{ padding: "10px 10px", borderRight: "1px dashed #ccc", color: "#333", verticalAlign: "top", whiteSpace: "nowrap" }}>{t.id}</td>
                    <td style={{ padding: "10px 10px", borderRight: "1px dashed #ccc", color: "#333", verticalAlign: "top", whiteSpace: "nowrap" }}>
                      {t.date}<br />{t.time}
                    </td>
                    <td style={{ padding: "10px 10px", borderRight: "1px dashed #ccc", color: "#0645ad", verticalAlign: "top", cursor: "pointer" }}>{t.remarks}</td>
                    <td style={{ padding: "10px 10px", borderRight: "1px dashed #ccc", color: "#333", verticalAlign: "top" }}></td>
                    <td style={{ padding: "10px 10px", borderRight: "1px dashed #ccc", color: "#333", verticalAlign: "top" }}>{t.utr}</td>
                    <td style={{ padding: "10px 10px", borderRight: "1px dashed #ccc", color: t.credit ? "#5a9e00" : "#333", verticalAlign: "top", textAlign: "right", whiteSpace: "nowrap" }}>{t.amount}</td>
                    <td style={{ padding: "10px 10px", color: "#5a9e00", verticalAlign: "top", textAlign: "right", whiteSpace: "nowrap" }}>{t.balance}</td>
                  </tr>
                ))}
              </tbody>
            </table>
